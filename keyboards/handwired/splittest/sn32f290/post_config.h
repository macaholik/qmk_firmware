...
#    elif defined(USE_SDI3)
#        define SOFT_SERIAL_PIN D12
#        define SERIAL_USART_RX_PIN D13 // USART RX pin
#        define SERIAL_USART_DRIVER SD3 // USART driver of TX and RX pin. default: SD1
#    else
